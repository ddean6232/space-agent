...
Hearts covers the human relationship layer: customers, partners, team, reputation, trust, communication, and culture.
...
### Diamonds: Value And Money

Diamonds covers financial value: offers, pricing, revenue, cash, margin, assets, and measurable economic performance.
...
### Spades: Operations And Execution

Spades covers the work engine: digging, building, processes, delivery, SOPs, quality, tools, automations, and day-to-day execution.
...
### Clubs: Risk, Strategy, And Governance

Clubs covers strategy, risk, compliance, constraints, decisions, governance, and existential threats. The metaphor is defensive and forceful: identifying threats, clubbing down risk, and protecting the business from avoidable harm.
...
## How Dealer's Table Uses The Deck
...
The five starter widgets can map to the deck:
